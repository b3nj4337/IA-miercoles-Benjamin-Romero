...
st.set_page_config(page_title="ST.IA", page_icon="😁")
st.title("mi chat bot con Streamlit")

nombre = st.text_input("Cual es tu nombre?")
if st.button("👋"):
    st.write(f"Bienvenido a mi chat bot, {nombre} 😊!")
...
def main ():
    ...
    area_chat()
    mensaje = st.chat_input("insertar texto...")
...
if __name__ == "__main__":
    main()
# python -m streamlit run app.py para correr app